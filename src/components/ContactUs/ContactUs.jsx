...
const ContactUs = () => {
  ...
  return (
    ...
    >
      <div
        className="fixedBg bg-center bg-no-repeat before:absolute before:z-[1] before:inset-0 before:opacity-90 before:bg-[#120815] bg-[#120815] bg-blend-multiply overflow-hidden"
        style={{ backgroundImage: `url(${SectionBg})` }}
      ></div>
      <div className="container sm:container md:container lg:container xl:container 2xl:container mx-auto">
        <SectionTitleLight2
          title={t("contact.title")}
          titleInner={t("contact.titleInner")}
          desc={t("contact.desc")}
        ></SectionTitleLight2>
