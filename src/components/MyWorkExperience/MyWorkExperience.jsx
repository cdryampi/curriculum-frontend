                  ...
                  <div className="grid gap-[1.875rem] xl:grid-cols-2 lg:grid-cols-1 grid-cols-1 items-center">
                    <div className="gridItem xl:order-1">
                      <div className="expImg relative overflow-hidden rounded-[10px] sm:rounded-[1.25rem] lg:rounded-[1.875rem] xl:rounded-[3.125rem] max-h-[14rem] opacity-0">
                        <img className="w-full" src={item?.logo_empresa_fondo?.image_for_mobile_url} alt={item?.logo_empresa_fondo?.title} loading="lazy" />
                        <img className="absolute bottom-1/3 left-1/2 transform -translate-x-1/2 min-w-[100px] min-h-[100px] max-w-[200px] max-h-[200px] object-contain" src={item?.logo_empresa?.file} alt={item?.logo_empresa?.title} loading="lazy" />
                      </div>
                    </div>
