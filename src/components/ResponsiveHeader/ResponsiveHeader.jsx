        ...
        <div className="container mx-auto">
          <div className="flex items-center justify-between w-full topbarInner">
            <div className="logo inline-block max-w-[50%]">
              <RouterLink to="/" title="ir a la página de inicio" className="flex items-center text-white font-Poppins font-bold text-[2rem]">
            ...
            <button
              ...
              onClick={toggleMenu}
              aria-label={responsiveMenu ? "Cerrar menú" : "Abrir menú"}
