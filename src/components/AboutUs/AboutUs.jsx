    ...
    if (userData?.disponibilidad) {
      return (
        <span className="inline-flex items-center gap-2">
          ...
          <span className="mt-1.5">{t("about.available")}</span>
        </span>
      )
    } else {
      return (
        <span className="inline-flex items-center gap-2">
          ...
          <span className="mt-1.5">{t("about.unavailable")}</span>
        </span>
      )
    }
  }
  ...
  return (
    <section className="aboutUsWrap py-[4.5rem] md:py-[5.5rem] lg:py-[6.5rem] xl:py-[7.5rem] relative w-full" id="about">
      ...
      <div className="container mx-auto">
        <SectionTitle title={t("about.title")} titleInner={t("about.titleInner")} desc={userData?.description} htmlDesc></SectionTitle>
            ...
            <div>
              <div className="aboutCapWrap w-full">
                <div className="aboutCap relative rounded-[10px] sm:rounded-[1.25rem] md:rounded-[3.125rem] overflow-hidden z-[1] lg:py-12 xl:pt-[4.6875rem] xl:pb-[4.375rem] p-5 md:p-10 lg:px-[3.5rem] xl:px-20">
                  ...
                  ></div>
                  <h3 className="text-accent2 font-light text-[1.5rem] md:text-[1.875rem] leading-tight font-Poppins">{t("about.hello")}</h3>
                  ...
                  <ul className="grid grid-cols-1 gap-5 mt-6">
                    <li className="grid grid-cols-2 gap-4 text-[1rem] md:text-[1.125rem]">
                      <strong className="text-desc3 uppercase font-bold font-Poppins col-span-1">{t("about.age")}</strong>
                      <span className="text-desc2 font-semibold font-NunitoSans col-span-1">{userData?.edad}</span>
                    </li>
                    <li className="grid grid-cols-2 gap-4 text-[1rem] md:text-[1.125rem]">
                      <strong className="text-desc3 uppercase font-bold font-Poppins col-span-1">{t("about.phone")}</strong>
                      <span className="text-desc2 font-semibold font-NunitoSans col-span-1">
                        <a className="text-desc2 font-semibold font-NunitoSans hover:text-accent" href={`tel:+34 ${userData?.telefono}`} title={t("about.phoneTitle")}>+34 {userData?.telefono}</a>
                      </span>
                    </li>
                    <li className="grid grid-cols-2 gap-4 text-[1rem] md:text-[1.125rem]">
                      <strong className="text-desc3 uppercase font-bold font-Poppins col-span-1">{t("about.email")}</strong>
                      <span className="text-desc2 font-semibold font-NunitoSans col-span-1">
                        <a className="text-desc2 font-semibold font-NunitoSans hover:text-accent" href={`mailto:${userData?.correo_electronico}`} title={t("about.emailTitle")}>{userData?.correo_electronico}</a>
                      </span>
                    </li>
                    <li className="grid grid-cols-2 gap-4 text-[1rem] md:text-[1.125rem]">
                      <strong className="text-desc3 uppercase font-bold font-Poppins col-span-1">{t("about.address")}</strong>
                      <span className="text-desc2 font-semibold font-NunitoSans col-span-1">{userData?.direccion}</span>
                    </li>
                    <li className="grid grid-cols-2 gap-4 text-[1rem] md:text-[1.125rem]">
                      <strong className="text-desc3 uppercase font-bold font-Poppins col-span-1">{t("about.status")}</strong>
